             ...
             if (Math.random() < 0.15) { // 15% chance to change location
                ...
                productToMisplace.currentShelfLocationId = newShelf.id + "-SIM"; // Mark as simulated new location
                 if (oldLocation !== productToMisplace.currentShelfLocationId) {
                    showToast(translate('toast_item_misplaced_sim', {itemName: productToMisplace.name, currentShelf: productToMisplace.currentShelfLocationId, correctShelf: productToMisplace.shelfLocationId || 'N/A'}), 'warning', 3000);
                 }
             }
          }
